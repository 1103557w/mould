...
from wtforms import IntegerField, RadioField, FloatField, SelectField, SubmitField, StringField
from wtforms.validators import InputRequired, NumberRange, Optional


class CalculatorForm(FlaskForm):
    severity_choices = [(.7, "70%"), (0.75, "75%"), (0.8, "80%"), (0.85, "85%"), (0.9, "90%"), (0.95, "95%"),
                        (1, "100%")]
    ...
    mould_months = IntegerField(label="Number of Months Mould Experienced: ",
                                validators=[InputRequired(), NumberRange(1, 40)])
...
class DumbForm(FlaskForm):
    text = StringField(label="fart", validators=[Optional()])
    submit = SubmitField(label="toot")
